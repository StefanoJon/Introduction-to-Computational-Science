...
def main():
    ...
    fig.suptitle('Average transient lengths with differing alphabet size (k) and neighbourhood (r)')
    ...
    fig = plt.figure(figsize=(12,8))
    fig.suptitle('Average Shannon Entropies with differing alphabet size (k) and neighbourhood (r)')
